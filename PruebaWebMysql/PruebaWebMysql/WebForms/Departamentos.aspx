<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departamentos.aspx.cs" Inherits="PruebaWebMysql.WebForms.Departamentos" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="main row">
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="container">
                        <asp:GridView ID="TablaDepartamentos" runat="server"></asp:GridView>
                    </div>
                </div>
            </div>
        </div>
